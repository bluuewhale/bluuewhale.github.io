+++
title = '가상 네트워크 인터페이스 (Linux Virtual Networking Interface)'
date = '2021-06-24T23:19:56+09:00'
draft = false
slug = 'linux-virtual-networking-interface'
description = '컨테이너 기술의 기반이 되는 리눅스 가상 네트워킹 인터페이스(Bridge, Bonded Interface, Team Device, VLAN, VETH)를 정리합니다.'
tags = ['Linux', 'Networking', 'Bridge', 'VLAN', 'VETH', 'Containers']
categories = ['Linux', 'Networking']

[cover]
image = 'images/linux-virtual-networking-interface/image1.png'
alt = 'Linux Bridge 네트워크 구성도'
hiddenInSingle = true
+++
...
![](/images/linux-virtual-networking-interface/image4.png)
...
[VLAN 설명](https://www.joinc.co.kr/w/man/12/VLAN)
